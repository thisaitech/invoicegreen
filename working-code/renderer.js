...
async function initializeNewEstimate() {
  ...
  // Clear advanced payment, previous balance and rounding
...
// ============================================================================
// CUSTOMER MANAGEMENT (integrated to prevent missing function errors)
// ============================================================================
...
function openCustomerModal(customer = null) {
  ...
  if (customer) {
    ...
    document.getElementById('modal-customer-country').value = customer.country || 'India';
    ...
    document.getElementById('modal-customer-country').value = 'India';
